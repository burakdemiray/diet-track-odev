          ...
          <div className="add-item-modal">
            <div className="modal__content">
              ...
              <div className="add-item-modal__row padding-bottom-20">
                <QuantitySelector
                  onUpdateQuantity={this.handleUpdateQty}
                  serving_unit={this.state.serving_unit}
                />
                <div className="calculated-weight">
                  <span className="large-text">
                    {Math.round(this.state.total_grams)}
                  </span>
                  <span className="caption">gram</span>
                </div>
                <div className="calculated-calories">
                  <span className="large-text">
                    {Math.round(this.state.total_calories)}
                  </span>
                  <span className="caption">kalori</span>
                </div>
              </div>
              <div className="add-item-modal__row padding-bottom-16 last-child">
                <div className="day-selector">
                  ...
                  <Select
                    ...
                    input={
                      <BootstrapInput name="mealTime" id="customized-select" />
                    }
                  ...
                  >
                    ...
                    <MenuItem value={'breakfast'}>Kahvalt</MenuItem>
