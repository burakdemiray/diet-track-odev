...
class App extends Component {
  constructor() {
    ...
    this.state.dataPoints.data_points[0].date = 'Bugün';
    this.state.dataPoints.data_points[1].date = 'Dün';
  ...
  custom_headers = {
    headers: {
      'x-app-id': '8f344a08',
      'x-app-key': '2e9e174ee9d6b855ab32fdbe36b242fb',
      'x-remote-user-id': '0',
    },
  };
  ...
  addItem(item) {
    const newDataPointsObj = {
      data_points: [...this.state.dataPoints.data_points],
    };
    const newDataPoint = {
      ...this.state.dataPoints.data_points[this.state.intakeHistoryPosition],
    };
    ...
    newDataPointsObj.data_points[this.state.intakeHistoryPosition] =
      newDataPoint;
    newDataPointsObj.data_points[
      this.state.intakeHistoryPosition
    ].total_calories += item.total_calories;
    newDataPointsObj.data_points[
      this.state.intakeHistoryPosition
    ].intake_list.push(item);
  ...
  navigateHistory(action) {
    if (action === '+') {
      if (
        this.state.intakeHistoryPosition <
        this.state.intakeHistory.length - 1
      ) {
          ...
          <div className="App Mobile">
            ...
            <nav>
              <HistoryNavigator
                ...
                dailyIntake={
                  this.state.dataPoints.data_points[
                    this.state.intakeHistoryPosition
                  ].date
                }
              />
            ...
            <div className="add-button">
              <Fab
                aria-label="add"
                color="primary"
                onClick={this.handelFocusSearch}
              >
                <AddIcon />
              </Fab>
            </div>
